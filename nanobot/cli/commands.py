...
app = typer.Typer(
    name="tinyclaw",
    help=f"{__logo__} tinyclaw - Personal AI Assistant",
...
def version_callback(value: bool):
    if value:
        console.print(f"{__logo__} tinyclaw v{__version__}")
        raise typer.Exit()
...
def main(
    ...
    """tinyclaw - Personal AI Assistant."""
    if help or ctx.invoked_subcommand is None:
        # Custom help display
        console.print()
        console.print(f"{__logo__} tinyclaw - Personal AI Assistant")
        console.print()
        ...
        options_table.add_row("--version", "-v", "Show version and exit.")
        ...
        commands_table.add_row("onboard", "Initialize tinyclaw configuration and workspace.")
        commands_table.add_row("gateway", "Start the tinyclaw gateway.")
        commands_table.add_row("agent", "Interact with the agent directly.")
        commands_table.add_row("status", "Show tinyclaw status.")
        commands_table.add_row("channels", "Manage channels")
        commands_table.add_row("cron", "Manage scheduled tasks")
...
@app.command()
def onboard():
    """Initialize tinyclaw configuration and workspace."""
    ...
    console.print(f"\n{__logo__} tinyclaw is ready!")
    console.print("\nNext steps:")
    console.print("  1. Add your API key to [cyan]~/.nanobot/config.json[/cyan]")
    console.print("     Get one at: https://openrouter.ai/keys")
    console.print("  2. Chat: [cyan]tinyclaw agent -m \"Hello!\"[/cyan]")
...
I am tinyclaw, a lightweight AI assistant.
...
def gateway(
    ...
    console.print(f"{__logo__} Starting tinyclaw gateway on port {port}...")
...
def agent(
    ...
    logs: bool = typer.Option(False, "--logs/--no-logs", help="Show tinyclaw runtime logs during chat"),
):
    ...
    def _thinking_ctx():
        if logs:
            ...
            return nullcontext()
        return console.status("[dim]tinyclaw is thinking...[/dim]", spinner="dots")
...
def status():
    ...
    console.print(f"{__logo__} tinyclaw Status\n")
